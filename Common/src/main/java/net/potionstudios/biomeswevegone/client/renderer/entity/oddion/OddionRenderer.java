...
public class OddionRenderer<R extends EntityRenderState & GeoRenderState> extends GeoEntityRenderer<Oddion, R> {
    ...
    @Override
    public void extractRenderState(@NotNull Oddion entity, @NotNull R entityRenderState, float partialTick) {
        super.extractRenderState(entity, entityRenderState, partialTick);
        entityRenderState.addGeckolibData(VARIANT, entity.getVariant().getSerializedName());
    }
}
